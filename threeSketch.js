...
function init() {
    ...
    //set up our scene
    light = new THREE.AmbientLight( 0xfffafe,1 ); // soft white light
    
    scene.add( light );
    pointLight = new THREE.PointLight( 0xfffafe, 200, 0 );
...
function render(){
    ...
    for (let i = 0; i < cubes.length; i++) {
        ...
        let height = (THREE.MathUtils.smootherstep(sine,-0.5,0.5))*5;//https://threejs.org/docs/?q=Math#api/en/math/MathUtils
        cube.scale.y = height;
